...
const commands: Array<{ keywords: string[]; route: string }> = [
  { keywords: ['offres', 'produits'], route: '/producer/offers' },
  { keywords: ['récoltes', 'moisson'], route: '/producer/harvests' },
  { keywords: ['vente', 'ventes'], route: '/producer/sales' },
  { keywords: ['commande', 'commandes'], route: '/producer/order-management' },
  { keywords: ['production', 'produire'], route: '/producer/production' },
  { keywords: ['prix', 'tarifs'], route: '/producer/prices' },
  { keywords: ['revenu', 'revenue'], route: '/producer/revenue' },
  { keywords: ['vocal', 'voix'], route: '/producer/vocal' },
  { keywords: ['tableau', 'dashboard', 'accueil'], route: '/producer/dashboard' },
  { keywords: ['compte', 'profil', 'paramètres'], route: '/user/preferences' },
];
